...
export default function CreateButton(props: ButtonProps): JSX.Element {
    return (
        <button {...props} className='px-[9.5px] py-[11px] bg-header-background text-light-grey text-xs leading-[14.63px] font-semibold uppercase flex rounded-md'>
