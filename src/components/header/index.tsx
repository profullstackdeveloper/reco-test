        ...
        <div className='h-full flex flex-col justify-center'>
            ...
            <HeaderButton targetPath='/processes'>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M6 10.2562H9.06244V16.0414H13.2" stroke="#FAFAFA" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M6 10.2562H9.06244V4.47107H13.2" stroke="#FAFAFA" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <HeaderButton targetPath='/incidents'>
                <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M1.95117 15L8.42255 8.36684C8.61876 8.16572 8.94212 8.16572 9.13833 8.36684L13.3006 12.6332C13.4968 12.8343 13.8202 12.8343 14.0164 12.6332L20 6.5" stroke="#FAFAFA" strokeWidth="2" strokeLinecap="round" />
                </svg>
                Incidents
            </HeaderButton>
        </div>
